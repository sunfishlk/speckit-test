...
- [X] T059 Add error recovery for model load failures in src/loaders/model-loader.js (retry mechanism with exponential backoff, detailed error messages, user-friendly fallback)
